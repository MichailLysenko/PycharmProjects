...
class WeatherForecast:
    ...
    def __init__(self): # Tu nalezy odczytac plik i zapisac do data, uzupelnienie slownika w srodku inita
...
rain = weather_forecast.get_rain_forecast(latitude, longitude)
...
class WeatherForecast:
    ...
    @staticmethod
    def open_file_new_weather_forecast2(): # Powtaryajacz sie czyn. Ale przy kazdym uruchomieniu API otwiera sie tylko raz i raz sie zapisuje
